...
const ProductDetail = ({product_name, id}) => {
    ...
    const addToExistingCart = async () => {
        ...
        try { 
            ...
            const restOfItems = stock - cartItemQuantity
            ...
            if(stock === 0){
                ...
                toast({
                    title: `Only ${restOfItems} left and you already have ${cartItemQuantity} of this item in your cart.`,
                    status: "error",
                    description: err.response.data.message,
                })
            }
                                        ...
                                        {addNote === true ? (
                                            <Box>
                                                <Input
                                                    ...
                                                    placeholder={
                                                        "Example: white color, medium size"
                                                    }
                                                    width={"234px"}
                                                    height={"40px"}
                                                    margin={"0px"}
